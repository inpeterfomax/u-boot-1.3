 ...
 */
int tsec_initialize(bd_t * bis, int index, char *devname)// index:0 devname:TSEC0
{
	...
	priv->phyregs = (volatile tsec_t *)(TSEC_BASE_ADDR + tsec_info[index].phyregidx *TSEC_SIZE);
